...
// Computed para saber si tiene variantes
const hasVariants = computed(() => form.colors.length > 0)

// Computed para calcular el stock total de las variantes
...
// Computed para obtener la imagen predeterminada de las variantes
...
// Watch para sincronizar el stock cuando hay variantes
watch(() => form.colors, () => {
...
// Watch para sincronizar la imagen thumbnail con la variante predeterminada
watch(() => [form.colors, hasVariants.value], () => {
  if (hasVariants.value && defaultVariantImage.value) {
    // Si hay una imagen en la variante predeterminada, usarla como thumbnail
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="px-4 py-6">
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <!-- Imagen Principal del Producto (solo si NO hay variantes) -->
        <FormSection v-if="!hasVariants" title="Imagen Principal">
          <ImageUploader :form="form" />
        </FormSection>

        <!-- Info de stock e imagen cuando hay variantes -->
        <div v-if="hasVariants" class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              <h4 class="text-sm font-medium text-purple-900 mb-1">Producto con variantes</h4>
              <ul class="text-sm text-purple-700 space-y-1">
                ...
                <li>• Stock total calculado: <span class="font-semibold">{{ totalVariantsStock }} unidades</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
            <p class="text-xs text-gray-600"><span class="text-red-600">*</span> Campos obligatorios</p>
